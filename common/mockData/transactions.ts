...
export const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  { id: 'TX-6', date: '2023-10-18', description: 'Fleet Maintenance', amount: -450.00, type: 'debit', status: 'completed', method: 'Visa •••• 4242' },
  { id: 'TX-7', date: '2023-10-15', description: 'Bulk Shipping Discount', amount: 150.00, type: 'credit', status: 'completed', method: 'Wallet Balance' },
];
