...
export const Step1Addresses: React.FC<any> = ({ data, onNext }) => {
  ...
  // Validation strictly requires pickup address selection
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-end pt-4">
        <Button onClick={() => onNext({ seller: s, buyer: b, pickup: p })} disabled={!isValid} className="px-12 h-14 bg-slate-900 text-white font-black uppercase tracking-widest text-xs">
