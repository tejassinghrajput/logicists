...
import { Building2, Mail, Phone, MapPin, Upload, Globe, FileText } from 'lucide-react';
        ...
        <div className="flex flex-col xl:flex-row gap-8 mt-2">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                    <Input label="Legal Business Name" defaultValue="Logistics Pro Solutions LLC" icon={Building2} placeholder="e.g. Acme Logistics Inc." />
                </div>
                ...
                <div className="md:col-span-2">
                    <Input label="Website" defaultValue="https://logisticspro.com" icon={Globe} placeholder="https://" />
                </div>

                <div className="md:col-span-2">
                    <Input label="Headquarters Address" defaultValue="1200 Logistics Way, San Francisco, CA 94103" icon={MapPin} />
                </div>
